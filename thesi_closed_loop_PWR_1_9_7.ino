...
#define FW_VERSION_STRING "PWR-1.9.7"
...
#define EEPROM_MAGIC       0x50575248UL  // "PWRH"
#define EEPROM_MAGIC_NAME  "PWR17"
...
void handlePowerLoop() {
  ...
  if (bangBangHigh && noLoadGuard && desiredDuty > cfg.noLoadDutyX10) desiredDuty = cfg.noLoadDutyX10;
...
void printStatus() {
  ...
  CmdSerial.print("No-load guard en/duty/window/fullcycles/count/slot/I/R/state: ");
