...
#define FW_VERSION_STRING "PWR-1.8.0"
...
#define EEPROM_MAGIC       0x50575238UL  // "PWR8"
#define EEPROM_MAGIC_NAME  "PWR8"
...
#define DEFAULT_EN_GATE_LEAD_CYCLES   6UL
...
void setGateCarrierDrive(bool enable) {
  if (enable) TIM1->BDTR |= (1UL << 15);
  else TIM1->BDTR &= ~(1UL << 15);
  enSyncCarrierActive = enable;
}

void startGateCarrierDriveCycle() {
  TIM1->CNT = 0;
  TIM1->SR &= ~TIM_SR_UIF;
