...
#define FW_VERSION_STRING "PWR-1.9.14"
...
#define EEPROM_MAGIC       0x5057524BUL  // "PWRK"
#define EEPROM_MAGIC_NAME  "PWR20"
...
void handlePowerLoop() {
  ...
  if (bangBangHigh && cfg.lineFfEnable) {
