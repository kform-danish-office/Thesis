...
#define FW_VERSION_STRING "PWR-1.9.10"
...
#define EEPROM_MAGIC       0x5057524AUL  // "PWRJ"
#define EEPROM_MAGIC_NAME  "PWR19"
...
void printParams() {
  ...
  CmdSerial.println("VMIN, VMAX, VSET, VON, OVP, OVPEN, NLGUARD, NLDUTY, NLDROP/NLBAND, NLFULL, NLSLOT, NLI, NLR");
...
void printCompensationValues() {
  ...
  CmdSerial.println("# Paste this block into another board running PWR-1.9.10 or newer.");
