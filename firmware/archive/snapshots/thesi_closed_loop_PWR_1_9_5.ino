...
//   Normal band is VMIN..VMAX; no-load band is VSET-NLDROP..VSET.
// ============================================================
...
#define FW_VERSION_STRING "PWR-1.9.5"
...
#define EEPROM_MAGIC       0x50575246UL  // "PWRF"
#define EEPROM_MAGIC_NAME  "PWR15"
...
void handlePowerLoop() {
  ...
  float turnOnV = noLoadGuard ? noLoadLowV : cfg.secMinV;
...
void printParams() {
  ...
  CmdSerial.println("VMIN, VMAX, VSET, OVP, OVPEN, NLGUARD, NLDUTY, NLDROP/NLBAND, NLFULL, NLI, NLR");
  ...
  CmdSerial.println("Commands: ON, OFF, OPEN, BANG/POWER, PFBPRI, PFBSEC, AUTOPRE, AUTOBANG/CAL, CALLOAD n, CAL3, LOAD n, ZEROI, FAST, TURBO, ULTRA, CLR, SAVE, DEFAULTS");
}
...
void printStatus() {
  ...
  CmdSerial.print("Voltage setpoint VSET: "); CmdSerial.print(cfg.voltageSetV, 2); CmdSerial.println(" V");
  CmdSerial.print("No-load guard en/duty/window/fullcycles/count/I/R/state: ");
