...
//
// Firmware version:
//   PWR-1.2.0 = adds 0.1% average precharge, AUTOPRE, and high-voltage tune stop.
//
// Fixed carrier:
...
#define FW_VERSION_STRING "PWR-1.2.0"
...
void printParams() {
  ...
  CmdSerial.println("Commands: ON, OFF, OPEN, POWER, AUTOPRE, CAL/AUTOFULL, CALLOAD n, CAL3, LOAD n, ZEROI, CLR, SAVE, DEFAULTS");
}
