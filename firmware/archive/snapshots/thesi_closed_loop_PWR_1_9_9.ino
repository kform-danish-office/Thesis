...
#define FW_VERSION_STRING "PWR-1.9.9"
...
void printParams() {
  ...
  CmdSerial.println("Commands: ON, OFF, OPEN, BANG/POWER, VSBONLY, LINEFF, LFFCAL, PFBPRI, PFBSEC, AUTOPRE, AUTOBANG/CAL, CALLOAD n, CAL3, LOAD n, ZEROI, FAST, TURBO, ULTRA, MAXRATE, FULL, CLR, SAVE, DEFAULTS");
}
