...
#define FW_VERSION_STRING "PWR-1.9.0"
...
#define EEPROM_MAGIC       0x50575242UL  // "PWRB"
#define EEPROM_MAGIC_NAME  "PWR11"
...
void handlePowerLoop() {
  ...
  if (bangBangHigh) {
    if (filteredVsec >= cfg.secMaxV && dwellMs >= cfg.bangMinOnMs) {
      bangBangHigh = false;
