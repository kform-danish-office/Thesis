...
#define FW_VERSION_STRING "PWR-1.7.2"
...
#define EEPROM_MAGIC       0x50575237UL  // "PWR7"
#define EEPROM_MAGIC_NAME  "PWR7"
...
void printParams() {
  ...
  CmdSerial.println("FEN, FMIN, FMAX, FPREF, FPEN, MINEDGE, GATECYC, STATIC, DMIN, DMAX, OD, BIAS, PWRDUTY");
...
void printStatus() {
  ...
  CmdSerial.print("PA10 period/high/minedge/gatecycles/gatemin/static100: ");
