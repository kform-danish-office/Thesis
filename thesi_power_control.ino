...
#define FW_VERSION_STRING "PWR-1.9.8"
...
#define EEPROM_MAGIC       0x50575249UL  // "PWRI"
#define EEPROM_MAGIC_NAME  "PWR18"
...
const char *modeName() {
  return controlMode == MODE_OPEN_LOOP ? "OPEN" : "VSB";
}
...
void printParams() {
  ...
  CmdSerial.println("Commands: ON, OFF, OPEN, BANG/POWER, PFBPRI, PFBSEC, AUTOPRE, AUTOBANG/CAL, CALLOAD n, CAL3, LOAD n, ZEROI, FAST, TURBO, ULTRA, FULL, CLR, SAVE, DEFAULTS");
}
...
void printStatus() {
  ...
  CmdSerial.print("Control source: PA1 secondary Vsb/Vsec only"); CmdSerial.println();
